...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-10 lg:px-12">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            ...
            {/* IBM logo for mobile and desktop */}
            <div className="flex-shrink-0 flex items-center ml-4 md:ml-0">
              <span className="text-xl font-bold text-black-800">IBM</span>
            </div>
          ...
          {/* Right side - icons for both mobile and desktop */}
      ...
      {/* Full-width dropdown for desktop */}
      {activeDropdown && (
        <div
          ref={dropdownRef}
          className="hidden md:block absolute left-0 w-full bg-white shadow-lg z-10 border-t border-gray-200"
          style={{ height: "30vh" }}
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {dropdownContent[activeDropdown]?.map((item, index) => (
                <a
                  key={index}
                  href={item.href}
                  className="group p-3 rounded-md hover:bg-gray-50 transition-colors duration-200"
                >
